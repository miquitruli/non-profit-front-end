...
const About = () => {
    return(
        <React.Fragment>
        <h1>About us!</h1>
        <h4>The Micaella Foundation is a foundation that main goal is to facilitate humanitarian action. 
        ...
        Both humanitarian and development aid are related, and different forms of aid often have both humanitarian and development components.
        </h4>
        </React.Fragment>
    )
}
